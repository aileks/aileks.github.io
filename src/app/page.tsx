...
export default function Home() {
  return (
    <>
      <main className="flex flex-col mt-12 w-full space-y-24">
        ...
        <div className="about-container self-end max-w-md">
          ...
          <p className="text-lg text-left">
            ...
            in Software Engineering with a passion for technology and the web as
            a platform. Ever since I was a kid I've been tinkering with gadgets
            and teaching myself things. My passion for tech drives me and I'm
